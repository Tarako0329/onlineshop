  <HEADER class='common_header' id='header'>
    <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" style='padding:0;'>
      <div class="container common_header">
        ...
        <a class="navbar-brand alice-regular" href="index.php?key=<?php echo $user_hash;?>"><h1 style='color:brown;'><?php echo TITLE;?></h1></a>
        ...
        <div class="collapse navbar-collapse ms-5" id="navbarNav">
          <ul class="navbar-nav alice-regular">
            <li class="nav-item">
              <a class="nav-link" href="index.php?key=<?php echo $user_hash;?>" id='menu_home'>Home</a>
            </li>
            <li class="nav-item">
