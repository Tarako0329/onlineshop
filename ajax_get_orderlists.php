<?php
  require "php_header.php";
	...
	if($rtn !== true){
	  ...
	  $sql = 
			"select HD.uid,HD.orderNO,HD.juchuu_date,HD.name,HD.yubin,HD.jusho,HD.tel,HD.mail,HD.st_name,HD.st_yubin,HD.st_jusho,HD.st_tel,HD.bikou,HD.post_corp,HD.postage,HD.postage_zeikbn,HD.postage_url,HD.postage_no,UMS.lock_sts,HD.cancel,UMS.yagou,UMS.tel as shop_tel,UMS.mail as shop_mail
