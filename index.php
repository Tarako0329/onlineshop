...
<head prefix="og: http://ogp.me/ns#">
    ...
    <meta property="og:site_name" content="<?php echo APP_NAME;?> 通販サイト" />

    <TITLE><?php echo APP_NAME;?>(プレゼントセレクション) 通販サイト</TITLE>
</head>
<BODY >
            ...
            <div class='row'><!--問合せ・シェアボタン-->
              ...
              <div class='col-6 mt-2 mb-2 ps-3'>
                <div class=''>
                    ...
                    <!--TWITTER-->
                    <a :href='`https://x.com/intent/tweet?text=私のおすすめ！\n${product_url}${list.uid}-${list.shouhinCD}&url=${product_url}${list.uid}-${list.shouhinCD}&z=X&via=${list.x_id}&related=${list.x_id}&hashtags=${list.hash_tag.replaceAll("#","")}`' rel="nofollow noopener noreferrer" target="_blank">
                ...
                <div class="accordion" :id="`accordion_${index}`">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button @click='shouhin_open_log(list.uid,list.shouhinCD,index)' class="accordion-button" style='font-size:15px;font-weight:400;' type="button" data-bs-toggle="collapse" :data-bs-target="`#collapseOne_${index}`" aria-expanded="true" aria-controls="collapseOne">
                        商品詳細・ご注文はコチラ
                      </button>
                    </h2>
